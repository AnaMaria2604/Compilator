...
declarare_var : TYPE lista_variabile { adaugaVariabila($1, "tip", 0, 0, 0, yylineno, 0, 0, '0', ""); }
              ...
              | TYPE ID ASSIGN NR { adaugaVariabila($2, "variabila", 0, 0, 0, yylineno, $4, 0, '0', ""); }
              | TYPE ID ASSIGN FLOAT_NR { adaugaVariabila($2, "variabila", 0, 0, 0, yylineno, 0, $4, '0', ""); }
              | TYPE ID ASSIGN STRING_VAL { adaugaVariabila($2, "variabila", 0, 0, 0, yylineno, 0, 0, '0', $4); }
              | TYPE ID ASSIGN CHAR_VAL { adaugaVariabila($2, "variabila", 0, 0, 0, yylineno, 0, 0, $4[0], ""); }
              ;
...
tipeof : TYPEOF '(' expr ')' /*{$$ = $3->TypeOf(yylineno);}*/
       ;
